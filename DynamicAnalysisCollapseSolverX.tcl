...
proc DynamicAnalysisCollapseSolverX {dt dt_anal_Step GMtime numStories DriftLimit MFFloorNodes EGFFloorNodes h1 htyp TraceGFDrift StartTime MaxRunTime GMname} {
...
SDRlimitTester $numStories $DriftLimit $MFFloorNodes $EGFFloorNodes $h1 $htyp $TraceGFDrift $GMname
