...
# Beam elements
element elasticBeamColumn 10020104 10020103 10020206 13870.94 $E [expr ($n+1)/$n*665970280.96] 2;  element elasticBeamColumn 10020211 10020203 10020208 13870.94 $E [expr ($n+1)/$n*665970280.96] 2;  element elasticBeamColumn 10020212 10020208 10020306 13870.94 $E [expr ($n+1)/$n*665970280.96] 2;  element elasticBeamColumn 10020304 10020303 10020406 13870.94 $E [expr ($n+1)/$n*665970280.96] 2;
element elasticBeamColumn 10030104 10030103 10030206 13870.94 $E [expr ($n+1)/$n*665970280.96] 2;  element elasticBeamColumn 10030211 10030203 10030208 13870.94 $E [expr ($n+1)/$n*665970280.96] 2;  element elasticBeamColumn 10030212 10030208 10030306 13870.94 $E [expr ($n+1)/$n*665970280.96] 2;  element elasticBeamColumn 10030304 10030303 10030406 13870.94 $E [expr ($n+1)/$n*665970280.96] 2;
element elasticBeamColumn 10040104 10040103 10040206 10774.17 $E [expr ($n+1)/$n*486990767.95] 2;  element elasticBeamColumn 10040211 10040203 10040208 10774.17 $E [expr ($n+1)/$n*486990767.95] 2;  element elasticBeamColumn 10040212 10040208 10040306 10774.17 $E [expr ($n+1)/$n*486990767.95] 2;  element elasticBeamColumn 10040304 10040303 10040406 10774.17 $E [expr ($n+1)/$n*486990767.95] 2;
element elasticBeamColumn 10050104 10050103 10050206 10774.17 $E [expr ($n+1)/$n*486990767.95] 2;  element elasticBeamColumn 10050211 10050203 10050208 10774.17 $E [expr ($n+1)/$n*486990767.95] 2;  element elasticBeamColumn 10050212 10050208 10050306 10774.17 $E [expr ($n+1)/$n*486990767.95] 2;  element elasticBeamColumn 10050304 10050303 10050406 10774.17 $E [expr ($n+1)/$n*486990767.95] 2;
...
uniaxialMaterial Steel01 100 200000 100000 0.02;  # BRB 1
uniaxialMaterial Steel02 200 100000 50000 0.02;  # BRB 2
set BRBmat 100;
element twoNodeLink 11 10010200 10020208 -mat $BRBmat -dir 1; element twoNodeLink 12 10010300 10020208 -mat $BRBmat -dir 1;
element twoNodeLink 21 11020209 10030208 -mat $BRBmat -dir 1; element twoNodeLink 22 11020308 10030208 -mat $BRBmat -dir 1;
element twoNodeLink 31 11030209 10040208 -mat $BRBmat -dir 1; element twoNodeLink 32 11030308 10040208 -mat $BRBmat -dir 1;
element twoNodeLink 41 11040209 10050208 -mat $BRBmat -dir 1; element twoNodeLink 42 11040308 10050208 -mat $BRBmat -dir 1;
...
# BRB 
recorder Element -file $MainFolder/$SubFolder/BRB11.out -time -ele 11 material 1 stressStrain; recorder Element -file $MainFolder/$SubFolder/BRB12.out -time -ele 12 material 1 stressStrain;
recorder Element -file $MainFolder/$SubFolder/BRB21.out -time -ele 21 material 1 stressStrain; recorder Element -file $MainFolder/$SubFolder/BRB22.out -time -ele 22 material 1 stressStrain;
recorder Element -file $MainFolder/$SubFolder/BRB31.out -time -ele 31 material 1 stressStrain; recorder Element -file $MainFolder/$SubFolder/BRB32.out -time -ele 32 material 1 stressStrain;
recorder Element -file $MainFolder/$SubFolder/BRB41.out -time -ele 41 material 1 stressStrain; recorder Element -file $MainFolder/$SubFolder/BRB42.out -time -ele 42 material 1 stressStrain;
...
# Frame name: 4SMRF_AE
# Generation time: 2024-03-31 21:57:34.063551
