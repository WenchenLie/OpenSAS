...
# Column elements
# element elasticBeamColumn 10010101 10010101 10020102 $A_col1to3 $Ec [expr ($n+1)/$n*$I_col1to3*$EIEg_col_1E] 2;  element elasticBeamColumn 10010201 10010201 10020202 $A_col1to3 $Ec [expr ($n+1)/$n*$I_col1to3*$EIEg_col_1I] 2;
                                                                                                                                                                                                                                  element elasticBeamColumn 10010301 10010301 10020302 $A_col1to3 $Ec [expr ($n+1)/$n*$I_col1to3*$EIEg_col_1I] 2;  element elasticBeamColumn 10010401 10010401 10020402 $A_col1to3 $Ec [expr ($n+1)/$n*$I_col1to3*$EIEg_col_1E] 2;
...
# ---------------------- DMIW ---------------------------------
# Nodes (10SSAA11, 10SSAA12)
set dist_1 441.4;
set dist_2to6 312.5;
node 10010111 $Axis1 [expr $Floor1 + $dist_1]; node 10010112 $Axis1 [expr (4300.-550.)-$dist_1]; node 10010211 $Axis2 [expr (4300.-550.)/3+$dist_1]; node 10010212 $Axis2 [expr (4300.-550.)*2/3-$dist_1]; 

# Elements
# element elasticBeamColumn 10010101 10010101 10020102 $A_col1to3 $Ec [expr ($n+1)/$n*$I_col1to3*$EIEg_col_1E] 2;  element elasticBeamColumn 10010201 10010201 10020202 $A_col1to3 $Ec [expr ($n+1)/$n*$I_col1to3*$EIEg_col_1I] 2;
element elasticBeamColumn 10010101 10010101 10020102 $A_col1to3 $Ec [expr ($n+1)/$n*$I_col1to3*$EIEg_col_1E] 2;
