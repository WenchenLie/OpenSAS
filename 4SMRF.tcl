...
element elasticBeamColumn   604100      413      511  14451.5840 $E [expr ($n+1)/$n*874085993.7600] $trans_selected; element elasticBeamColumn   604200      423      521  15935.4520 $E [expr ($n+1)/$n*986468478.6720] $trans_selected; element elasticBeamColumn   604300      433      531  15935.4520 $E [expr ($n+1)/$n*986468478.6720] $trans_selected; element elasticBeamColumn   604400      443      541  14451.5840 $E [expr ($n+1)/$n*874085993.7600] $trans_selected; 
element elasticBeamColumn   603102   103172      411 14451.5840 $E [expr ($n+1)/$n*874085993.7600] $trans_selected;  element elasticBeamColumn   603202   103272      421 15935.4520 $E [expr ($n+1)/$n*986468478.6720] $trans_selected;  element elasticBeamColumn   603302   103372      431 15935.4520 $E [expr ($n+1)/$n*986468478.6720] $trans_selected;  element elasticBeamColumn   603402   103472      441 14451.5840 $E [expr ($n+1)/$n*874085993.7600] $trans_selected;  
element elasticBeamColumn   603101      313   103171 19548.3480 $E [expr ($n+1)/$n*1248694276.8000] $trans_selected;  element elasticBeamColumn   603201      323   103271 27741.8800 $E [expr ($n+1)/$n*1906339929.2480] $trans_selected;  element elasticBeamColumn   603301      333   103371 27741.8800 $E [expr ($n+1)/$n*1906339929.2480] $trans_selected;  element elasticBeamColumn   603401      343   103471 19548.3480 $E [expr ($n+1)/$n*1248694276.8000] $trans_selected;  
element elasticBeamColumn   602100      213      311  19548.3480 $E [expr ($n+1)/$n*1248694276.8000] $trans_selected; element elasticBeamColumn   602200      223      321  27741.8800 $E [expr ($n+1)/$n*1906339929.2480] $trans_selected; element elasticBeamColumn   602300      233      331  27741.8800 $E [expr ($n+1)/$n*1906339929.2480] $trans_selected; element elasticBeamColumn   602400      243      341  19548.3480 $E [expr ($n+1)/$n*1248694276.8000] $trans_selected; 
element elasticBeamColumn   601100      113      211  19548.3480 $E [expr ($n+1)/$n*1248694276.8000] $trans_selected; element elasticBeamColumn   601200      123      221  27741.8800 $E [expr ($n+1)/$n*1906339929.2480] $trans_selected; element elasticBeamColumn   601300      133      231  27741.8800 $E [expr ($n+1)/$n*1906339929.2480] $trans_selected; element elasticBeamColumn   601400      143      241  19548.3480 $E [expr ($n+1)/$n*1248694276.8000] $trans_selected; 

# BEAMS
# element ModElasticBeam2d   505100      514      522  11354.8160 $E [expr ($n+1)/$n*0.90*$Comp_I*409571722.7904] $K11_2 $K33_2 $K44_2 $trans_selected; element ModElasticBeam2d   505200      524      532  11354.8160 $E [expr ($n+1)/$n*0.90*$Comp_I*409571722.7904] $K11_2 $K33_2 $K44_2 $trans_selected; element ModElasticBeam2d   505300      534      542  11354.8160 $E [expr ($n+1)/$n*0.90*$Comp_I*409571722.7904] $K11_2 $K33_2 $K44_2 $trans_selected; 
# element ModElasticBeam2d   504100      414      422  11354.8160 $E [expr ($n+1)/$n*0.90*$Comp_I*409571722.7904] $K11_2 $K33_2 $K44_2 $trans_selected; element ModElasticBeam2d   504200      424      432  11354.8160 $E [expr ($n+1)/$n*0.90*$Comp_I*409571722.7904] $K11_2 $K33_2 $K44_2 $trans_selected; element ModElasticBeam2d   504300      434      442  11354.8160 $E [expr ($n+1)/$n*0.90*$Comp_I*409571722.7904] $K11_2 $K33_2 $K44_2 $trans_selected; 
# element ModElasticBeam2d   503100      314      322  14451.5840 $E [expr ($n+1)/$n*0.90*$Comp_I*874085993.7600] $K11_2 $K33_2 $K44_2 $trans_selected; element ModElasticBeam2d   503200      324      332  14451.5840 $E [expr ($n+1)/$n*0.90*$Comp_I*874085993.7600] $K11_2 $K33_2 $K44_2 $trans_selected; element ModElasticBeam2d   503300      334      342  14451.5840 $E [expr ($n+1)/$n*0.90*$Comp_I*874085993.7600] $K11_2 $K33_2 $K44_2 $trans_selected; 
# element ModElasticBeam2d   502100      214      222  14451.5840 $E [expr ($n+1)/$n*0.90*$Comp_I*874085993.7600] $K11_2 $K33_2 $K44_2 $trans_selected; element ModElasticBeam2d   502200      224      232  14451.5840 $E [expr ($n+1)/$n*0.90*$Comp_I*874085993.7600] $K11_2 $K33_2 $K44_2 $trans_selected; element ModElasticBeam2d   502300      234      242  14451.5840 $E [expr ($n+1)/$n*0.90*$Comp_I*874085993.7600] $K11_2 $K33_2 $K44_2 $trans_selected; 

element elasticBeamColumn   505100      514      522  11354.8160 $E [expr ($n+1)/$n*0.90*$Comp_I*409571722.7904] $trans_selected; element elasticBeamColumn   505200      524      532  11354.8160 $E [expr ($n+1)/$n*0.90*$Comp_I*409571722.7904] $trans_selected; element elasticBeamColumn   505300      534      542  11354.8160 $E [expr ($n+1)/$n*0.90*$Comp_I*409571722.7904] $trans_selected; 
element elasticBeamColumn   504100      414      422  11354.8160 $E [expr ($n+1)/$n*0.90*$Comp_I*409571722.7904] $trans_selected; element elasticBeamColumn   504200      424      432  11354.8160 $E [expr ($n+1)/$n*0.90*$Comp_I*409571722.7904] $trans_selected; element elasticBeamColumn   504300      434      442  11354.8160 $E [expr ($n+1)/$n*0.90*$Comp_I*409571722.7904] $trans_selected; 
element elasticBeamColumn   503100      314      322  14451.5840 $E [expr ($n+1)/$n*0.90*$Comp_I*874085993.7600] $trans_selected; element elasticBeamColumn   503200      324      332  14451.5840 $E [expr ($n+1)/$n*0.90*$Comp_I*874085993.7600] $trans_selected; element elasticBeamColumn   503300      334      342  14451.5840 $E [expr ($n+1)/$n*0.90*$Comp_I*874085993.7600] $trans_selected; 
element elasticBeamColumn   502100      214      222  14451.5840 $E [expr ($n+1)/$n*0.90*$Comp_I*874085993.7600] $trans_selected; element elasticBeamColumn   502200      224      232  14451.5840 $E [expr ($n+1)/$n*0.90*$Comp_I*874085993.7600] $trans_selected; element elasticBeamColumn   502300      234      242  14451.5840 $E [expr ($n+1)/$n*0.90*$Comp_I*874085993.7600] $trans_selected; 
