...
if __name__ == "__main__":
    ...
    # 层间位移角
    Model_4StoryMRF = FragilityAnalysis(r'H:\MRF_results\4SMRF_AE_SPD0_Steel02_out', EDP_type=1)
    ...
    Model_4StoryMRF.Save_data(r'H:\MRF_results\4SMRF_AE_SPD0_Steel02_out_frag')
