# ---------------------------- add 4-story rocking frame with TSTD ------------------------------------
...
# TSTD paramenters
set My 61217.0; set K 9.137e6;  # TSTD-1
...
# Link beam hinge
source add/Spring_TSTD.tcl
Spring_TSTD 9002984 29840 2984 $My $K; Spring_TSTD 900212 212 2120 $My $K;  # floor 2
Spring_TSTD 9003984 39840 3984 $My $K; Spring_TSTD 900312 312 3120 $My $K;  # floor 3
Spring_TSTD 9004984 49840 4984 $My $K; Spring_TSTD 900412 412 4120 $My $K;  # floor 4
Spring_TSTD 9005984 59840 5984 $My $K; Spring_TSTD 900512 512 5120 $My $K;  # floor 5
...
# TSTD behavior (floor: 2-5, axis: 1-4)
recorder Element -file $MainFolder/$SubFolder/TSTD21_u.out -ele 9002984 material 3 stressStrain; recorder Element -file $MainFolder/$SubFolder/TSTD22_u.out -ele 900212 material 3 stressStrain;  # floor 2
recorder Element -file $MainFolder/$SubFolder/TSTD31_u.out -ele 9003984 material 3 stressStrain; recorder Element -file $MainFolder/$SubFolder/TSTD32_u.out -ele 900312 material 3 stressStrain;  # floor 3
recorder Element -file $MainFolder/$SubFolder/TSTD41_u.out -ele 9004984 material 3 stressStrain; recorder Element -file $MainFolder/$SubFolder/TSTD42_u.out -ele 900412 material 3 stressStrain;  # floor 4
recorder Element -file $MainFolder/$SubFolder/TSTD51_u.out -ele 9005984 material 3 stressStrain; recorder Element -file $MainFolder/$SubFolder/TSTD52_u.out -ele 900512 material 3 stressStrain;  # floor 5
