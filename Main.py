...
if __name__ == "__main__":
    ...
    notes = """
    """  # 模型说明
    model = MRF('4SMRF_AS', N=4, notes=notes)
    ...
    model.set_running_parameters(Output_dir='H:/MRF_results/test/4SMRF_AS', fv_duration=0, display=True, log_name='日志', auto_quit=False)
